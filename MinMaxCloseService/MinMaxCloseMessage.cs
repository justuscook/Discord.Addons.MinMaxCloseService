...
namespace Discord.Addons.MinMaxClose
{
    public class MinMaxCloseMessage
    {
		...
		public MinMaxCloseMessage(IUserMessage message, SocketCommandContext context, bool canOthersClose = false, bool infoCaled = false, bool maximized = true)
		{
			Message = message;
